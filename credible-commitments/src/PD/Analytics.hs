...
isEquilibriumPrisonersDilemmaAliceChoiceTransferBribe commitment strat = generateIsEq $ evaluate (prisonersDilemmaAliceChoiceTransferBribe commitment) strat void
